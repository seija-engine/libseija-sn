...
import com.seija.core.reflect.{TypeInfo, Assembly, NotFoundTypeInfoException}
...
object XmlNSResolver {
    val default = { 
        ...
        ruled.addImport("com.seija.ui.controls.*")
        ruled.addImport("com.seija.ui.resources.*")
        ruled.addImport("com.seija.ui.visualState.*")
        ruled.addImport("com.seija.ui.trigger.*")
        ruled.addImport("com.seija.ui.core.Thickness")
