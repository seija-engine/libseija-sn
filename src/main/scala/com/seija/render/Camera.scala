...
class CameraBuilder  (
    ...
    def build(entity: Entity): Unit = {
        ...
        FFISeijaRender.renderEntityAddCamera(com.seija.core.App.worldPtr,entity.id,cameraPtr)
    }
}
...
given CameraComponent:RawComponent[Camera] with {
    ...
    def getRaw(entity:Entity,isMut:Boolean):RawCamera = FFISeijaRender.renderEntityGetCamera(com.seija.core.App.worldPtr,entity.id)
}
